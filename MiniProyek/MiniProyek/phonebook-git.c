...
void header()
{
    ...
    printf("\t\t\t                                                            \n");
    printf("\t\t\t                                                            \n");
    printf("\t\t\t                     Welcome to MyCon Phonebook!            \n");
    printf("\t\t\t                                                            \n");
    printf("\t\t\t                                                            \n");
    printf("\t\t\t    ============================================================\n\n");
}
...
int menu()
{
    ...
    {
    case '1':
        view_all_contact();										//masuk ke fungsi add_contact() jika ditekan 1
        break;
    case '2':
        add_contact();									//masuk ke fungsi search_contact() jika ditekan 2
        break;
    case '3':
        delete_contact();									//masuk ke fungsi delete_contact() jika ditekan 3
        break;
    case '4':
        search_contact();									//masuk ke fungsi view_all_contact() jika ditekan 4
        break;
    case '5':
...
void add_contact()
{
    ...
    fp=fopen("contact.csv","a+");							//file open contact.txt dengan access mode a+
